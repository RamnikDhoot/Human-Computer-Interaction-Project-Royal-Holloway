...
function Signup() {
    const [formData, setFormData] = useState({
      ...
      const [passwordDescription, setPasswordDescription] = useState('Enter a password to see its strength.');
    ...
    <div className="text-center">
      ...
      <div className="sign-up-container">
        <form className="form-signup" onSubmit={handleSubmit}>
          <h1 className="h3 mb-3 font-weight-normal form-signup-heading">Sign Up</h1>
      ...
      <div id="passwordStrength" className="progress" style={{ height: '5px', marginTop: '5px' }}>
            <div
