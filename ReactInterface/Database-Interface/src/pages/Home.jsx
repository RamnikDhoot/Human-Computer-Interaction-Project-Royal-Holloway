/**
 * HomePage component for displaying the home page with inventory items.
 *
 */
 ...
 *
 * @returns {JSX.Element} JSX representing the HomePage component.
 */
function HomePage() {
   ...
   * Adds a new inventory item to the inventory array with a unique ID.
   */
