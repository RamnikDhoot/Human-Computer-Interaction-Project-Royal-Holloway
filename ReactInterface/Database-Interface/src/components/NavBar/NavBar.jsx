    ...
    <>
      <nav className="navbar navbar-expand-lg sticky-top">
        <div className="container-fluid">
          ...
          <Tooltip text="Toggle navigation menu">
            <button
          ...
          <div className="collapse navbar-collapse" id="navbarContent">
            ...
            <div className="navbar-brand dropdown">
              <Tooltip text="Access your profile, settings, or sign out">
                <a
                  href="#"
              ...
              <Tooltip text="Search the site">
                <div className="input-group rounded-pill">
                  ...
                  <button
                    ...
                    type="submit"
                  >
                    <img src="\src\components\NavBar\search.svg" alt="Search" />
                  </button>
                </div>{" "}
              </Tooltip>
            </form>
